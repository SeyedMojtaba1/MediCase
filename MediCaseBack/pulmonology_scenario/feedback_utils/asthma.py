ASTHMA_EXERCISE_INDUCED_DETAILED = {
  "history_taking": {
    "present_illness": {
      "question1": {
      ...
      "question2": {
        ...
        "analysis": "شروع علائم معمولاً حاد و حمله‌ای (Paroxysmal) است که با محرک فیزیکی (دویدن، فوتبال، هوای سرد) تحریک می‌شود."
      },
      "question3": {
      ...
      "question4": {
        ...
        "analysis": "سرفه خشک و آزاردهنده بعد از ورزش یکی از شایع‌ترین (و گاهی تنها) علامت آسم ورزشی است."
      },
      "question5": {
        "question": "آیا خس خس سینه یا تنفس پر سر و صدا دارید؟",
        "analysis": "ویزینگ (Wheezing) بازدمی بعد از فعالیت شدید شایع است، اما ممکن است در زمان معاینه (در مطب) شنیده نشود."
      },
      "question6": {
        "question": "آیا درد یا گرفتگی قفسه سینه دارید؟ آیا با تنفس یا حرکت تغییر می‌کند؟",
        "analysis": "احساس سنگینی و فشار روی قفسه سینه (Chest Tightness) بعد از دویدن، شکایت شایعی است که گاهی با درد قلبی اشتباه گرفته می‌شود."
      },
      "question7": {
        "question": "آیا اخیراً تب، لرز یا تعریق شبانه داشته‌اید؟",
        "analysis": "منفی است. این یک پروسه التهابی/مکانیکی راه هوایی است، نه عفونی."
      },
      "question8": {
      ...
      "question9": {
        ...
        "analysis": "منفی است (طبق فایل منطق). ممکن است این اولین باری باشد که بیمار به دلیل محدودیت در ورزش مراجعه کرده است، یا قبلاً فکر می‌کرده «آمادگی جسمانی پایین» دارد."
      },
      "question10": {
    ...
    "past_medical_history": {
      "question1": {
        "question1a": {
          ...
          "analysis": "سابقه رینیت آلرژیک (آبریزش بینی فصلی) یا اگزما، احتمال تشخیص آسم ورزشی را تقویت می‌کند."
        },
        "question1b": {
          "question": "اگر بله، تشخیص این بیماری از چه موقع بوده است؟",
          "analysis": "اطلاعات تکمیلی."
        }
      },
      "question2": {
        "question2a": {
    ...
    "drug_history": {
      "question1": {
        "question1a": {
          ...
          "analysis": "بررسی مصرف داروها برای رد علل دارویی تنگی نفس (مثل بتابلاکرها) مهم است. در این سناریو فرض بر این است که بیمار داروی خاصی مصرف نمی‌کند."
        },
        "question1b": {
    ...
    "family_history": {
      "question1": {
        "question1a": {
          ...
          "analysis": "سابقه آسم یا آلرژی در والدین."
        },
        "question1b": {
    ...
    "social_history": {
      "question1": {
        "question1a": {
          ...
          "analysis": "بسیار مهم. سیگار کشیدن می‌تواند علائم آسم ورزشی را تشدید کند یا خود عامل برونشیت باشد."
        },
        "question1b": {
      ...
      "question4": {
        ...
        "analysis": "مواجهه با هوای سرد و خشک یا آلاینده‌ها (کلر استخر، هوای آلوده) محرک اصلی EIB است."
      }
    },
    "ros": {
      "question1": {
  ...
  "physical_exam": {
    "vital_signs": {
      "BP": {"question": "فشار خون(BP)", "analysis": "نرمال."},
      "T": {"question": "دمای بدن(T)", "analysis": "نرمال."},
      "PR": {"question": "ضربان قلب(PR)", "analysis": "نرمال (در حالت استراحت)."},
      "RR": {"question": "تعداد تنفس(RR)", "analysis": "نرمال (در حالت استراحت)."},
      "SpO2": {"question": "غلظت O2(SpO2)", "analysis": "نرمال."},
      "GCS": {"question": "سطح هوشیاری(GCS)", "analysis": "نرمال."}
    },
    "general_appearance": {
      "mood_and_behavior": {"question": "مود و رفتار", "analysis": "نرمال."},
      "overall_appearance": {"question": "ظاهر کلی", "analysis": "نرمال. بیمار در حالت استراحت ظاهر کاملاً سالمی دارد."},
      "posture_and_position": {"question": "پوزیشن و وضعیت بدن", "analysis": "نرمال."},
      "level_of_consciousness": {"question": "سطح هوشیاری", "analysis": "نرمال."},
      "cardiopulmonary_and_circulatory_clues": {
        "edema": {"question": "اِدم", "analysis": "ندارد."},
        "dyspnea": {"question": "تنگی نفس", "analysis": "در حالت استراحت ندارد (اما در شرح حال ذکر شده)."},
        "cyanosis": {"question": "سیانوز", "analysis": "ندارد."}
      }
    },
    "head_and_neck": {
      "head_and_face": {
        "symmetry_and_lesions": {"question": "تقارن و ضایعات", "analysis": "نرمال."},
        "tenderness": {"question": "Tenderness", "analysis": "نرمال."}
      },
      "eyes": {
        "sclera_and_conjunctiva": {"question": "صلبیه و ملتحمه", "analysis": "نرمال."},
        "pupils_reaction": {"question": "رفلکس مردمک‌ها", "analysis": "نرمال."},
        "extraocular_movements": {"question": "حرکت چشم‌های خارجی", "analysis": "نرمال."}
      },
      "ears": {
        "external_and_tenderness": {"question": "حساسیت به لمس گوش خارجی", "analysis": "نرمال."},
        "eardrum_appearance": {"question": "ظاهر پرده گوش", "analysis": "نرمال."}
      },
      "nose_and_sinuses": {
        "septum_and_discharge": {"question": "سپتوم و ترشحات بینی", "analysis": "نرمال."},
        "sinus_tenderness": {"question": "حساسیت سینوسی", "analysis": "نرمال."}
      },
      "mouth_and_pharynx": {
        "oral_mucosa_and_lesions": {"question": "دهان و ضایعات داخل دهان", "analysis": "نرمال."},
        "pharynx_and_tonsils": {"question": "حلق و لوزه‌ها", "analysis": "نرمال."}
      },
      "neck_and_lymphatics": {
        "inspection": {"question": "مشاهدات گردن", "analysis": "نرمال."},
        "tracheal_position": {"question": "موقعیت تراشه", "analysis": "نرمال."},
        "thyroid_gland": {"question": "غده تیروئید", "analysis": "نرمال."},
        "carotid_bruit": {"question": "صدای کاروتید", "analysis": "نرمال."},
        "lymph_nodes_size_consistency": {"question": "اندازه و همگنی گره‌های لنفاوی", "analysis": "نرمال."},
        "lymph_nodes_mobility_tenderness": {"question": "حرکت و حساسیت گره‌های لنفاوی", "analysis": "نرمال."}
      }
    },
    "respiratory_system": {
      "inspection": {
        "accessory_muscles": {"question": "استفاده از عضلات کمکی", "analysis": "نرمال در حالت استراحت."},
        "chest_shape_and_symmetry": {"question": "شکل و تقارن قفسه سینه", "analysis": "نرمال."}
      },
      "palpation": {
        "chest_expansion": {"question": "گسترش قفسه سینه", "analysis": "نرمال."},
        "tactile_fremitus": {"question": "Tactile Fremitus", "analysis": "نرمال."}
      },
    ...
    "cardiovascular_system": {
      "JVP_assessment": {"question": "فشار ورید ژوگولار", "analysis": "نرمال."},
      "palpation": {
        "precordial_palpation_heave_thrill": {"question": "لمس قلب و بررسی Heave Thrill", "analysis": "نرمال."},
        "pmi_assessment": {"question": "بررسی PMI", "analysis": "نرمال."}
      },
      "auscultation": {
        "heart_sounds_s1_s2": {"question": "صدای قلب S1 و S2", "analysis": "نرمال."},
        "extra_sounds_s3_s4_murmurs": {"question": "صدای اضافی S3 و S4", "analysis": "نرمال."}
      },
      "peripheral_pulses_and_extremities": {
        "peripheral_pulses_symmetry_and_quality": {"question": "کیفیت و تقارن نبض‌های محیطی", "analysis": "نرمال."},
        "extremities_color_and_trophic_changes": {"question": "رنگ و تغییر شکل اندام‌ها", "analysis": "نرمال."},
        "extremities_temperature_and_cap_refill": {"question": "دمای اندام‌ها و بازگشتی مویرگی", "analysis": "نرمال."},
        "extremities_edema": {"question": "اِدم اندام‌ها", "analysis": "نرمال."}
      }
    },
    "abdominal_system": {
      "inspection": {"question": "مشاهده شکم", "analysis": "نرمال."},
      "auscultation": {
        "bowel_sounds": {"question": "صدای روده‌ها", "analysis": "نرمال."},
        "vascular_bruits": {"question": "برویی عروقی", "analysis": "نرمال."}
      },
      "percussion": {
        "general": {"question": "دق کلی شکم", "analysis": "نرمال."},
        "organ_borders": {"question": "حدود اندام‌ها", "analysis": "نرمال."}
      },
      "palpation": {
        "superficial_tenderness": {"question": "Tenderness سطحی", "analysis": "نرمال."},
        "deep_masses_and_organs": {"question": "ارگان ها و توده‌های عمقی", "analysis": "نرمال."}
      },
      "peritoneal_signs": {"question": "علائم صفاقی", "analysis": "نرمال."}
    },
    "neurological": {
      "mental_status_and_LOC": {"question": "وضعیت ذهنی و سطح هوشیاری", "analysis": "نرمال."},
      "cranial_nerves": {"question": "اعصاب مغزی", "analysis": "نرمال."},
      "motor_strength_and_tone": {"question": "قدرت حرکتی و تونوس", "analysis": "نرمال."},
      "involuntary_movements": {"question": "حرکات غیرارادی", "analysis": "نرمال."},
      "sensory_light_touch_and_pain": {"question": "لمس سطحی و درد", "analysis": "نرمال."},
      "deep_tendon_reflexes": {"question": "رفلکس های تاندونی عمیق", "analysis": "نرمال."},
      "coordination_and_gait": {"question": "هماهنگی و Gait", "analysis": "نرمال."}
    },
    "musculoskeletal_system": {
      "inspection": {
        "joints": {"question": "مفاصل", "analysis": "نرمال."},
        "muscles": {"question": "عضلات", "analysis": "نرمال."}
      },
      "palpation": {
        "tenderness_and_crepitus": {"question": "Tenderness and Crepitus", "analysis": "نرمال."}
      },
      "range_of_motion_active_passive": {"question": "محدوده حرکتی فعال و غیر فعال", "analysis": "نرمال."},
      "stability_and_function": {"question": "ثبات و عملکرد", "analysis": "نرمال."}
    }
  },
  "paraclinic": {
    "basic_blood_tests": {
      "BMP": {"question": "BMP", "analysis": "نرمال."},
      "CBC": {"question": "CBC", "analysis": "معمولاً نرمال است."},
      "ESR": {"question": "ESR", "analysis": "نرمال."},
      "CRP": {"question": "CRP", "analysis": "نرمال."},
      "VBG": {"question": "VBG", "analysis": "نرمال."},
  ...
  "differential_diagnosis": {
    ...
    "disease5": {"question": "IPF", "analysis": "نامرتبط."},
...
ASTHMA_EXERCISE_INDUCED = {
    "history_taking": {
      "present_illness": {
        ...
        "question5": "true", "question6": "true", "question7": "false", "question8": "false",
        "question9": "false", "question10": "false"
      },
      "past_medical_history": {
        "question1": { "question1a": "true", "question1b": "false" },
        "question2": { "question2a": "false", "question2b": "false" },
        "question3": "false", "question4": "false", "question5": "false", "question6": "false"
      },
      "drug_history": {
        "question1": { "question1a": "true", "question1b": "false", "question1c": "false" },
        "question2": "false"
      },
      ...
      "ros": {
        ...
        "question5": "false", "question6": "true", "question7": "true", "question8": "false",
    ...
    "physical_exam": {
      ...
      "general_appearance": {
        "mood_and_behavior": "true", "overall_appearance": "true", "posture_and_position": "false",
        "level_of_consciousness": "true",
        "cardiopulmonary_and_circulatory_clues": {
          "edema": "false", "dyspnea": "true", "cyanosis": "false"
        }
      },
      "head_and_neck": {
        ...
        "mouth_and_pharynx": { "oral_mucosa_and_lesions": "false", "pharynx_and_tonsils": "false" },
        "neck_and_lymphatics": {
          "inspection": "true", "tracheal_position": "false", "thyroid_gland": "false", "carotid_bruit": "false",
          "lymph_nodes_size_consistency": "false", "lymph_nodes_mobility_tenderness": "false"
        }
      },
      "respiratory_system": {
        "inspection": { "accessory_muscles": "false", "chest_shape_and_symmetry": "true" },
    ...
    "paraclinic": {
      "basic_blood_tests": {
        "BMP": "true", "CBC": "false", "ESR": "false", "CRP": "false", "VBG": "false", "LFTs": "false"
      },
      "specialized_lung_tests": {
        "D_dimer": "false", "Sputum_AFB": "false", "BNP_NT_proBNP": "false",
        "Sputum_analysis": "false", "a1_antitrypsin_level": "false"
      },
      "immunity_and_serology": {
        "HIV_test": "false", "Autoimmune_pannel_ANA_ANCA": "false"
      },
      "simple_imaging": {
        "Chest_X_Ray": "true"
      },
      ...
      "functional_tests": {
        "dlco": "false", "peak_flow": "true", "Spirometry": "true", "plethysmography": "false"
      },
      "procedures": {
        "Bronchoscopy": "false", "torachonthesis": "false"
      }
    },
    "differential_diagnosis": {
      "disease1": "true", "disease2": "false", "disease3": "false", "disease4": "false", "disease5": "false", "disease6": "false"
    },
    "final_diagnosis": { "disease": "Asthma" },
    "pleural_effusion_assessment": {
      "has_effusion": "false", "need_aspiration": "false", "effusion_type": "none"
    }
}
...
ASTHMA_MILD_ALLERGIC_DETAILED = {
  "history_taking": {
    "present_illness": {
      ...
      "question9": {"question": "آیا قبلاً هم مشکل مشابهی داشته‌اید و چه درمانی به شما کمک کرده است؟", "analysis": "سابقه پاسخ درمانی خوب به اسپری سالبوتامول (Quick Relief) تشخیص آسم را تایید می‌کند."},
      "question10": {"question": "آیا دچار کاهش وزن، خستگی یا از دست دادن اشتها شده‌اید؟", "analysis": "منفی است."}
    },
    "past_medical_history": {
      "question1": {
      ...
      "question2": {
        "question2a": {"question": "آیا تا به حال عمل جراحی (بزرگ یا کوچک) داشته‌اید؟ و آیا تا به حال در بیمارستان بستری شده‌اید؟", "analysis": "سابقه جراحی پولیپ بینی (Polypectomy) می‌تواند مرتبط باشد (همراهی آسم و پولیپ)."},
        "question2b": {"question": "اگر بله، دلیلش چه بوده و در چه سالی؟ همچنین، آیا تا به حال انتقال خون داشته‌اید؟", "analysis": "نامرتبط."}
      },
      "question3": {"question": "آیا سابقه بیماری های قلبی، ریوی و مغزی را دارید؟", "analysis": "برای رد کردن سایر علل تنگی نفس (مثل بیماری مادرزادی قلب در جوانان) پرسیده می‌شود."},
      "question4": {"question": "آیا در حال حاظر یا در گذشته سرطان فعال داشته‌اید؟", "analysis": "نامرتبط."},
      "question5": {"question": "در دوران کودکی، آیا بیماری‌های خاصی (مثل تب روماتیسمی، سرخک شدید) گرفتید یا به دلیل بیماری بستری شدید؟", "analysis": "سابقه برونشیولیت‌های مکرر ویروسی در کودکی می‌تواند ریسک آسم را بالا ببرد."},
      "question6": {"question": "برنامه واکسن‌ها (مثل کزاز و آنفولانزا) شما کامل و به روز است؟", "analysis": "نامرتبط."}
    },
    "drug_history": {
      "question1": {
        "question1a": {"question": "لطفاً لیست تمام داروهایی که در حال حاضر به صورت مرتب (روزانه، هفتگی یا ماهانه) مصرف می‌کنید را به من بگویید.", "analysis": "استفاده گاه‌به‌گاه از اسپری آبی (سالبوتامول) مشخصه آسم خفیف است. اگر بیمار نیاز به کورتون استنشاقی مداوم داشته باشد، یعنی آسم پایدار (Persistent) است."},
        "question1b": {"question": "دوز هر دارو چقدر است و چند بار در روز مصرف می‌کنید؟", "analysis": "تعداد پاف‌های مصرفی در هفته معیار کنترل بیماری است."},
        "question1c": {"question": "آیا در چند روز گذشته، دوز یا زمان مصرف هیچ‌کدام از این داروها را تغییر داده‌اید؟", "analysis": "افزایش مصرف نشانه شروع حمله است."}
      },
      "question2": {"question": "به صورت منظم داروهای بدون نسخه (OTC) (مثل داروهای سرماخوردگی، مسکن‌ها، آنتی‌اسیدها)، مکمل‌های غذایی، داروهای گیاهی یا خواب آور مصرف می‌کنید؟", "analysis": "مصرف آنتی‌هیستامین‌ها برای آلرژی فصلی سرنخ مهمی است."}
    },
    "allergies": {
      "question1": {
    ...
    "family_history": {
      "question1": {
        "question1a": {"question": "آیا در خانواده درجه یک (پدر، مادر، خواهر یا برادر) شما، سابقه ابتلا به بیماری‌های مزمن و شایع زیر وجود دارد؟", "analysis": "آسم و آلرژی زمینه ژنتیکی قوی دارند. داشتن والدین مبتلا، شانس آسم را در فرزند چند برابر می‌کند."},
        "question1b": {"question": "اگر بله، چه کسی و در چه سنی به آن مبتلا شده است؟", "analysis": "اهمیت ژنتیکی."}
      },
      "question2": {"question": "آیا در خانواده درجه یک شما، سابقه حمله قلبی (سکته قلبی)، سکته مغزی، یا نارسایی قلبی وجود دارد؟", "analysis": "نامرتبط."},
      "question3": {
        "question3a": {"question": "آیا سابقه سرطان خاصی در خانواده درجه یک شما وجود دارد؟", "analysis": "نامرتبط."},
        "question3b": {"question": "اگر بله، نوع سرطان چه بوده و در چه سنی تشخیص داده شده است؟", "analysis": "نامرتبط."}
      }
    },
    "social_history": {
      "question1": {
        "question1a": {"question": "آیا تا به حال سیگار، قلیان، پیپ، یا هر نوع محصول نیکوتینی مصرف کرده‌اید؟", "analysis": "حتی اگر بیمار سیگاری نباشد، مواجهه با دود دست دوم (Passive Smoking) می‌تواند محرک علائم باشد."},
        "question1b": {"question": "اگر قبلاً مصرف می‌کردید، چه زمانی ترک کرده‌اید؟", "analysis": "اطلاعات تکمیلی."}
      },
      "question2": {"question": "آیا الکل مصرف می‌کنید؟ اگر بله، نوع و میزان مصرف آن در هفته چقدر است؟", "analysis": "نامرتبط."},
      "question3": {
        "question3a": {"question": "آیا تا به حال مواد مخدر مصرف کرده‌اید؟", "analysis": "نامرتبط."},
        "question3b": {"question": "اگر مصرف داشته‌اید، نوع آن و آخرین باری که مصرف کرده‌اید چه زمانی بوده است؟", "analysis": "نامرتبط."}
      },
      "question4": {"question": "در خانه همراه چه کسانی زندگی می‌کنید؟", "analysis": "وجود حیوانات خانگی (گربه/سگ) یا رطوبت و کپک در محل زندگی، از مهم‌ترین تریگرهای آسم آلرژیک هستند."}
    },
    "ros": {
      ...
      "question9": {"question": "آیا دچار درد یا سوزش حین ادرار کردن، تکرر ادرار، خون در ادرار (هماچوری)، مشکل در کنترل ادرار، یا ترشحات غیرعادی هستید؟", "analysis": "نامرتبط."},
      "question10": {"question": "آیا دچار درد مفاصل، سفتی صبحگاهی، تورم مفاصل، درد یا ضعف عضلانی، یا کمردرد مزمن هستید؟", "analysis": "نامرتبط."},
      "question11": {"question": "آیا سابقه سردرد شدید یا جدید، تشنج، ضعف یا بی‌حسی در دست‌ها/پاها، مشکل در تعادل/هماهنگی، یا تغییر در حافظه دارید؟", "analysis": "نامرتبط."},
      "question12": {"question": "آیا اخیراً احساس افسردگی، اضطراب، تغییرات شدید خلقی، یا مشکل در خواب (بی‌خوابی/پرخوابی) داشته‌اید؟", "analysis": "نامرتبط."},
      "question13": {"question": "آیا دچار افزایش تشنگی، افزایش گرسنگی، افزایش ادرار (پلی اوری)، یا عدم تحمل گرما/سرما شده‌اید؟", "analysis": "نامرتبط."},
      "question14": {"question": "آیا سابقه کبودی آسان، خونریزی طولانی‌مدت، بزرگ شدن غدد لنفاوی، یا کم‌خونی شدید دارید؟", "analysis": "نامرتبط."}
    }
  },
  "physical_exam": {
    "vital_signs": {
      "BP": {"question": "فشار خون(BP)", "analysis": "نرمال."},
      "T": {"question": "دمای بدن(T)", "analysis": "نرمال."},
      "PR": {"question": "ضربان قلب(PR)", "analysis": "معمولاً نرمال است، مگر در حین حمله که تاکیکاردی خفیف دیده می‌شود."},
      "RR": {"question": "تعداد تنفس(RR)", "analysis": "نرمال یا کمی افزایش یافته."},
      "SpO2": {"question": "غلظت O2(SpO2)", "analysis": "نرمال (بالای ۹۷٪). در آسم خفیف، اکسیژن خون معمولاً افت نمی‌کند."},
      "GCS": {"question": "سطح هوشیاری(GCS)", "analysis": "نرمال."}
    },
    "general_appearance": {
      "mood_and_behavior": {"question": "مود و رفتار", "analysis": "هوشیار و آرام، بدون دیسترس شدید."},
      "overall_appearance": {"question": "ظاهر کلی", "analysis": "خوب. بیمار ممکن است کمی سرفه کند."},
      "posture_and_position": {"question": "پوزیشن و وضعیت بدن", "analysis": "نرمال (می‌تواند صاف دراز بکشد)."},
      "level_of_consciousness": {"question": "سطح هوشیاری", "analysis": "نرمال."},
      "cardiopulmonary_and_circulatory_clues": {
        "edema": {"question": "اِدم", "analysis": "ندارد."},
        "dyspnea": {"question": "تنگی نفس", "analysis": "تنگی نفس خفیف یا متناوب."},
        "cyanosis": {"question": "سیانوز", "analysis": "ندارد."}
      }
    },
    "head_and_neck": {
      "head_and_face": {
        "symmetry_and_lesions": {"question": "تقارن و ضایعات", "analysis": "ممکن است خط افقی روی بینی (Allergic Crease) ناشی از مالیدن مداوم بینی دیده شود."},
        "tenderness": {"question": "Tenderness", "analysis": "حساسیت سینوس‌ها در صورت سینوزیت آلرژیک."}
      },
      "eyes": {
        "sclera_and_conjunctiva": {"question": "صلبیه و ملتحمه", "analysis": "ممکن است پرخونی ملتحمه یا تیرگی زیر چشم (Allergic Shiners) وجود داشته باشد."},
        "pupils_reaction": {"question": "رفلکس مردمک‌ها", "analysis": "نرمال."},
        "extraocular_movements": {"question": "حرکت چشم‌های خارجی", "analysis": "نرمال."}
      },
      "ears": {
        "external_and_tenderness": {"question": "حساسیت به لمس گوش خارجی", "analysis": "نرمال."},
        "eardrum_appearance": {"question": "ظاهر پرده گوش", "analysis": "ممکن است مایع پشت گوش (Effusion) ناشی از اختلال عملکرد شیپور استاش (در زمینه آلرژی) دیده شود."}
      },
      "nose_and_sinuses": {
        "septum_and_discharge": {"question": "سپتوم و ترشحات بینی", "analysis": "مخاط بینی رنگ‌پریده و متورم (Boggy Turbinates) و ترشحات شفاف، نشانه رینیت آلرژیک است."},
        "sinus_tenderness": {"question": "حساسیت سینوسی", "analysis": "حساسیت."}
      },
      "mouth_and_pharynx": {
        "oral_mucosa_and_lesions": {"question": "دهان و ضایعات داخل دهان", "analysis": "نرمال."},
        "pharynx_and_tonsils": {"question": "حلق و لوزه‌ها", "analysis": "نمای سنگ‌فرشی (Cobblestoning) در ته حلق ناشی از ترشحات مزمن پشت حلق (Post-nasal drip) شایع است."}
      },
      "neck_and_lymphatics": {
        "inspection": {"question": "مشاهدات گردن", "analysis": "نرمال."},
        "tracheal_position": {"question": "موقعیت تراشه", "analysis": "نرمال."},
    ...
    "respiratory_system": {
      "inspection": {
        "accessory_muscles": {"question": "استفاده از عضلات کمکی", "analysis": "معمولاً استفاده نمی‌شود (مگر در حین حمله)."},
        "chest_shape_and_symmetry": {"question": "شکل و تقارن قفسه سینه", "analysis": "نرمال."}
      },
      "palpation": {
        "chest_expansion": {"question": "گسترش قفسه سینه", "analysis": "نرمال."},
...
ASTHMA_MILD_ALLERGIC = {
    "history_taking": {
      "present_illness": {
        "question1": "true", "question2": "true", "question3": "true", "question4": "true",
        "question5": "true", "question6": "true", "question7": "false", "question8": "false",
        "question9": "true", "question10": "false"
      },
      "past_medical_history": {
        "question1": { "question1a": "true", "question1b": "true" },
        "question2": { "question2a": "true", "question2b": "false" },
        "question3": "true", "question4": "false", "question5": "true", "question6": "false"
      },
      "drug_history": {
      ...
      "ros": {
        "question1": "false", "question2": "true", "question3": "false", "question4": "true",
        "question5": "true", "question6": "true", "question7": "true", "question8": "false",
        "question9": "false", "question10": "false", "question11": "false", "question12": "false",
        "question13": "false", "question14": "false"
      }
    },
    "physical_exam": {
      ...
      "head_and_neck": {
        ...
        "eyes": { "sclera_and_conjunctiva": "true", "pupils_reaction": "false", "extraocular_movements": "false" },
        "ears": { "external_and_tenderness": "false", "eardrum_appearance": "true" },
        "nose_and_sinuses": { "septum_and_discharge": "true", "sinus_tenderness": "true" },
        "mouth_and_pharynx": { "oral_mucosa_and_lesions": "true", "pharynx_and_tonsils": "true" },
        "neck_and_lymphatics": {
          "inspection": "true", "tracheal_position": "false", "thyroid_gland": "false", "carotid_bruit": "false",
          "lymph_nodes_size_consistency": "false", "lymph_nodes_mobility_tenderness": "false"
        }
    ...
    "paraclinic": {
      "basic_blood_tests": {
        "BMP": "true", "CBC": "true", "ESR": "false", "CRP": "false", "VBG": "false", "LFTs": "false"
      },
      "specialized_lung_tests": {
        "D_dimer": "false", "Sputum_AFB": "false", "BNP_NT_proBNP": "false",
        "Sputum_analysis": "false", "a1_antitrypsin_level": "false"
    ...
    "differential_diagnosis": {
      "disease1": "true", "disease2": "false", "disease3": "true", "disease4": "false", "disease5": "false", "disease6": "false"
    },
    "final_diagnosis": { "disease": "Asthma" },
    "pleural_effusion_assessment": {
      "has_effusion": "false", "need_aspiration": "false", "effusion_type": "none"
...
ASTHMA_SEVERE_UNCONTROLLED_DETAILED = {
  "history_taking": {
    "present_illness": {
      ...
      "question10": {"question": "آیا دچار کاهش وزن، خستگی یا از دست دادن اشتها شده‌اید؟", "analysis": "نامرتبط."}
    },
    "past_medical_history": {
      "question1": {
        "question1a": {"question": "آیا بیماری طولانی مدت (مزمن) مثل قند (دیابت)، فشار خون، آسم، مشکل تیروئید، یا بیماری جدی کلیوی/کبدی دارید؟", "analysis": "بیماری‌های همراه آتوپیک (اگزما، آلرژی بینی) تشخیص آسم را تقویت می‌کنند. همچنین ریفلاکس معده (GERD) می‌تواند باعث تشدید آسم شود."},
      ...
      "question4": {"question": "آیا در حال حاظر یا در گذشته سرطان فعال داشته‌اید؟", "analysis": "نامرتبط."},
      "question5": {"question": "در دوران کودکی، آیا بیماری‌های خاصی (مثل تب روماتیسمی، سرخک شدید) گرفتید یا به دلیل بیماری بستری شدید؟", "analysis": "نامرتبط."},
      "question6": {"question": "برنامه واکسن‌ها (مثل کزاز و آنفولانزا) شما کامل و به روز است؟", "analysis": "نامرتبط."}
    },
    "drug_history": {
      "question1": {
        "question1a": {"question": "لطفاً لیست تمام داروهایی که در حال حاضر به صورت مرتب (روزانه، هفتگی یا ماهانه) مصرف می‌کنید را به من بگویید.", "analysis": "بررسی تکنیک استفاده از اسپری (Inhaler Technique) و پایبندی به درمان (Adherence) حیاتی است. بسیاری از موارد «آسم شدید» در واقع «آسم بد درمان شده» هستند."},
        "question1b": {"question": "دوز هر دارو چقدر است و چند بار در روز مصرف می‌کنید؟", "analysis": "مصرف طولانی‌مدت کورتون خوراکی (پردنیزولون) نشانه آسم بسیار شدید و وابسته به استروئید است."},
        "question1c": {"question": "آیا در چند روز گذشته، دوز یا زمان مصرف هیچ‌کدام از این داروها را تغییر داده‌اید؟", "analysis": "آیا بیمار خودسرانه داروها را قطع کرده است؟"}
      },
      "question2": {"question": "به صورت منظم داروهای بدون نسخه (OTC) (مثل داروهای سرماخوردگی، مسکن‌ها، آنتی‌اسیدها)، مکمل‌های غذایی، داروهای گیاهی یا خواب آور مصرف می‌کنید؟", "analysis": "بتابلاکرها (حتی قطره چشمی تیمولول) و NSAIDها (آسپرین/بروفن) می‌توانند باعث برونکواسپاسم شدید در افراد مستعد شوند (NERD)."}
    },
    "allergies": {
      "question1": {
    ...
    "family_history": {
      "question1": {
        "question1a": {"question": "آیا در خانواده درجه یک (پدر، مادر، خواهر یا برادر) شما، سابقه ابتلا به بیماری‌های مزمن و شایع زیر وجود دارد؟", "analysis": "سابقه آتوپی (آسم، اگزما، رینیت آلرژیک) در خانواده قویاً زمینه ژنتیکی آسم را تایید می‌کند."},
        "question1b": {"question": "اگر بله، چه کسی و در چه سنی به آن مبتلا شده است؟", "analysis": "اهمیت ژنتیکی."}
      },
      "question2": {"question": "آیا در خانواده درجه یک شما، سابقه حمله قلبی (سکته قلبی)، سکته مغزی، یا نارسایی قلبی وجود دارد؟", "analysis": "نامرتبط."},
      "question3": {
    ...
    "social_history": {
      "question1": {
        "question1a": {"question": "آیا تا به حال سیگار، قلیان، پیپ، یا هر نوع محصول نیکوتینی مصرف کرده‌اید؟", "analysis": "سیگار هم باعث تشدید آسم می‌شود و هم پاسخ به کورتون‌های استنشاقی را کم می‌کند. همچنین می‌تواند باعث همپوشانی آسم و COPD (ACO) شود."},
        "question1b": {"question": "اگر قبلاً مصرف می‌کردید، چه زمانی ترک کرده‌اید؟", "analysis": "بررسی مواجهه."}
      },
      "question2": {"question": "آیا الکل مصرف می‌کنید؟ اگر بله، نوع و میزان مصرف آن در هفته چقدر است؟", "analysis": "نامرتبط."},
      "question3": {
        "question3a": {"question": "آیا تا به حال مواد مخدر مصرف کرده‌اید؟", "analysis": "نامرتبط."},
      ...
      "question4": {"question": "در خانه همراه چه کسانی زندگی می‌کنید؟", "analysis": "وجود حیوانات خانگی (گربه/سگ)، گرد و غبار یا رطوبت (Mould) در خانه می‌تواند علت عدم کنترل آسم باشد."}
    },
    "ros": {
      "question1": {"question": "آیا اخیراً دچار تب، لرز، کاهش یا افزایش وزن ناخواسته، یا خستگی شدید و غیرمعمول شده‌اید؟", "analysis": "تب نشانه عفونت تنفسی (وایرال/باکتریال) به عنوان عامل شعله‌ورکننده حمله است."},
      "question2": {"question": "آیا سابقه راش، خارش، زخم‌های طولانی‌مدت، تغییر در رنگ یا بافت پوست/مو/ناخن، یا کبودی غیرعادی دارید؟", "analysis": "اگزما (درماتیت آتوپیک) همراهی شایعی با آسم دارد."},
      "question3": {"question": "آیا اخیراً دچار سردرد، سرگیجه، سفتی گردن، یا بزرگ شدن غدد لنفاوی در گردن شده‌اید؟", "analysis": "نامرتبط."},
      "question4": {"question": "آیا دچار تاری دید، دوبینی، درد چشم، قرمزی، یا کاهش دید ناگهانی شده‌اید؟", "analysis": "نامرتبط."},
      "question5": {"question": "آیا دچار وزوز گوش، کاهش شنوایی، خونریزی بینی، گرفتگی مزمن بینی، گلودرد مزمن، مشکل در بلع (دیسفاژی)، یا آفت و زخم‌های دهانی مکرر هستید؟", "analysis": "رینیت آلرژیک، گرفتگی بینی و سینوزیت مزمن کنترل آسم را بسیار دشوار می‌کنند (United Airway Disease)."},
      "question6": {"question": "آیا سابقه درد قفسه سینه، تپش قلب، تنگی نفس با فعالیت، تنگی نفس در حالت خوابیده (ارتوپنه)، یا تورم پاها (ادم) دارید؟", "analysis": "تنگی نفس و تپش قلب (ناشی از داروها) شایع است."},
      "question7": {"question": "آیا سابقه سرفه، خس‌خس سینه، خلط خونی (هموپتیزی)، یا تنگی نفس (به جز تنگی نفس مرتبط با فعالیت شدید) دارید؟", "analysis": "علائم اصلی آسم."},
      "question8": {"question": "آیا دچار حالت تهوع، استفراغ، سوزش سر دل، درد شکم، تغییر در عادات اجابت مزاج (اسهال یا یبوست)، خونریزی از مقعد، یا زردی پوست و چشم (یرقان) هستید؟", "analysis": "ریفلاکس معده (GERD) با میکروآسپیراسیون اسید می‌تواند باعث اسپاسم برونش و تشدید آسم شود."},
      "question9": {"question": "آیا دچار درد یا سوزش حین ادرار کردن، تکرر ادرار، خون در ادرار (هماچوری)، مشکل در کنترل ادرار، یا ترشحات غیرعادی هستید؟", "analysis": "نامرتبط."},
      "question10": {"question": "آیا دچار درد مفاصل، سفتی صبحگاهی، تورم مفاصل، درد یا ضعف عضلانی، یا کمردرد مزمن هستید؟", "analysis": "نامرتبط."},
      "question11": {"question": "آیا سابقه سردرد شدید یا جدید، تشنج، ضعف یا بی‌حسی در دست‌ها/پاها، مشکل در تعادل/هماهنگی، یا تغییر در حافظه دارید؟", "analysis": "نامرتبط."},
      "question12": {"question": "آیا اخیراً احساس افسردگی، اضطراب، تغییرات شدید خلقی، یا مشکل در خواب (بی‌خوابی/پرخوابی) داشته‌اید؟", "analysis": "اضطراب شدید ناشی از تنگی نفس شایع است و می‌تواند حمله را بدتر کند (Hyperventilation)."},
      "question13": {"question": "آیا دچار افزایش تشنگی، افزایش گرسنگی، افزایش ادرار (پلی اوری)، یا عدم تحمل گرما/سرما شده‌اید؟", "analysis": "نامرتبط."},
      "question14": {"question": "آیا سابقه کبودی آسان، خونریزی طولانی‌مدت، بزرگ شدن غدد لنفاوی، یا کم‌خونی شدید دارید؟", "analysis": "نامرتبط."}
    }
  },
  "physical_exam": {
    "vital_signs": {
      ...
      "SpO2": {"question": "غلظت O2(SpO2)", "analysis": "در حملات شدید افت می‌کند. هدف درمان حفظ بالای ۹۳-۹۵٪ است."},
      "GCS": {"question": "سطح هوشیاری(GCS)", "analysis": "گیجی یا خواب‌آلودگی علامت خطرناک هیپوکسی شدید یا افزایش CO2 و نیاز به اینتوباسیون فوری است."}
    },
    "general_appearance": {
      "mood_and_behavior": {"question": "مود و رفتار", "analysis": "بیمار بی‌قرار (Agitated) است و نمی‌تواند جملات کامل را بگوید (Speaking in phrases/words)."},
      "overall_appearance": {"question": "ظاهر کلی", "analysis": "نشستن رو به جلو (Tripod) و تلاش تنفسی واضح."},
      "posture_and_position": {"question": "پوزیشن و وضعیت بدن", "analysis": "ارتوپنه."},
      "level_of_consciousness": {"question": "سطح هوشیاری", "analysis": "هشدار: سکوت و خواب‌آلودگی در بیمار آسمی نشانه خستگی تنفسی قریب‌الوقوع است."},
      "cardiopulmonary_and_circulatory_clues": {
        "edema": {"question": "اِدم", "analysis": "ندارد."},
        "dyspnea": {"question": "تنگی نفس", "analysis": "شدید."},
        "cyanosis": {"question": "سیانوز", "analysis": "علامت دیررس و خطرناک."}
      }
    },
    "head_and_neck": {
      "head_and_face": {
        "symmetry_and_lesions": {"question": "تقارن و ضایعات", "analysis": "نرمال."},
        "tenderness": {"question": "Tenderness", "analysis": "حساسیت سینوس‌ها (سینوزیت)."}
      },
      "eyes": {
        "sclera_and_conjunctiva": {"question": "صلبیه و ملتحمه", "analysis": "نرمال."},
        "pupils_reaction": {"question": "رفلکس مردمک‌ها", "analysis": "نرمال."},
      ...
      "nose_and_sinuses": {
        "septum_and_discharge": {"question": "سپتوم و ترشحات بینی", "analysis": "تورم شاخک‌های بینی و ترشحات شفاف در رینیت آلرژیک. پولیپ بینی هم باید بررسی شود."},
        "sinus_tenderness": {"question": "حساسیت سینوسی", "analysis": "نرمال یا حساس."}
      },
      "mouth_and_pharynx": {
        "oral_mucosa_and_lesions": {"question": "دهان و ضایعات داخل دهان", "analysis": "نرمال."},
        "pharynx_and_tonsils": {"question": "حلق و لوزه‌ها", "analysis": "ترشحات پشت حلق (Post-nasal drip) که باعث تحریک سرفه."}
      },
      "neck_and_lymphatics": {
        "inspection": {"question": "مشاهدات گردن", "analysis": "استفاده شدید از عضلات فرعی گردن (SCM) و فرو رفتن حفره بالای جناغ (Suprasternal retraction)."},
        "tracheal_position": {"question": "موقعیت تراشه", "analysis": "نرمال. (باید پنوموتوراکس را رد کرد)."},
        "thyroid_gland": {"question": "غده تیروئید", "analysis": "نرمال."},
        "carotid_bruit": {"question": "صدای کاروتید", "analysis": "نرمال."},
        "lymph_nodes_size_consistency": {"question": "اندازه و همگنی گره‌های لنفاوی", "analysis": "نرمال."},
        "lymph_nodes_mobility_tenderness": {"question": "حرکت و حساسیت گره‌های لنفاوی", "analysis": "نرمال."}
    ...
    "respiratory_system": {
      "inspection": {
        "accessory_muscles": {"question": "استفاده از عضلات کمکی", "analysis": "نشانه اصلی دیسترس تنفسی و انسداد شدید جریان هوا."},
        "chest_shape_and_symmetry": {"question": "شکل و تقارن قفسه سینه", "analysis": "ممکن است قفسه سینه پرهوا (Hyperinflated) به نظر برسد."}
      },
      "palpation": {
        "chest_expansion": {"question": "گسترش قفسه سینه", "analysis": "کاهش یافته (به دلیل پرهوایی)."},
        "tactile_fremitus": {"question": "Tactile Fremitus", "analysis": "معمولاً نرمال یا کاهش یافته."}
      },
    ...
    "cardiovascular_system": {
      "JVP_assessment": {"question": "فشار ورید ژوگولار", "analysis": "ممکن است در بازدم برجسته شود."},
      "palpation": {
        "precordial_palpation_heave_thrill": {"question": "لمس قلب و بررسی Heave Thrill", "analysis": "نرمال."},
        "pmi_assessment": {"question": "بررسی PMI", "analysis": "نرمال."}
      },
      "auscultation": {
        "heart_sounds_s1_s2": {"question": "صدای قلب S1 و S2", "analysis": "تاکیکاردی."},
        "extra_sounds_s3_s4_murmurs": {"question": "صدای اضافی S3 و S4", "analysis": "نرمال."}
      },
      "peripheral_pulses_and_extremities": {
        "peripheral_pulses_symmetry_and_quality": {"question": "کیفیت و تقارن نبض‌های محیطی", "analysis": "بررسی پالس پارادوکس."},
        "extremities_color_and_trophic_changes": {"question": "رنگ و تغییر شکل اندام‌ها", "analysis": "نرمال."},
        "extremities_temperature_and_cap_refill": {"question": "دمای اندام‌ها و بازگشتی مویرگی", "analysis": "نرمال."},
        "extremities_edema": {"question": "اِدم اندام‌ها", "analysis": "ندارد."}
      }
    },
    "abdominal_system": {
      "inspection": {"question": "مشاهده شکم", "analysis": "نرمال."},
    ...
    "neurological": {
      "mental_status_and_LOC": {"question": "وضعیت ذهنی و سطح هوشیاری", "analysis": "نرمال یا مضطرب."},
      "cranial_nerves": {"question": "اعصاب مغزی", "analysis": "نرمال."},
      "motor_strength_and_tone": {"question": "قدرت حرکتی و تونوس", "analysis": "نرمال."},
      "involuntary_movements": {"question": "حرکات غیرارادی", "analysis": "نرمال."},
      "sensory_light_touch_and_pain": {"question": "لمس سطحی و درد", "analysis": "نرمال."},
  ...
  "differential_diagnosis": {
    "disease1": {"question": "Asthma", "analysis": "تشخیص قطعی. شرح حال نوسانی، ویزینگ، پاسخ به برونکودیلاتور و رد سایر علل."},
    "disease2": {"question": "Pneumonia", "analysis": "پنومونی می‌تواند تریگر حمله آسم باشد. وجود تب و اینفیلتراسیون در عکس ریه به نفع پنومونی است."},
    "disease3": {"question": "COPD", "analysis": "در افراد مسن و سیگاری مطرح است. در COPD انسداد کاملاً برگشت‌پذیر نیست و DLCO پایین است."},
    "disease4": {"question": "PTE", "analysis": "در هر بیمار با تنگی نفس ناگهانی باید در نظر گرفته شود، به خصوص اگر ویزینگ وجود نداشته باشد."},
    "disease5": {"question": "IPF", "analysis": "علائم مزمن، سرفه خشک و کراکل دارد، نه ویزینگ."},
...
ASTHMA_SEVERE_UNCONTROLLED = {
    ...
    "paraclinic": {
      "basic_blood_tests": {
        "BMP": "true", "CBC": "true", "ESR": "false", "CRP": "true", "VBG": "true", "LFTs": "false"
      },
      "specialized_lung_tests": {
    ...
    "differential_diagnosis": {
      "disease1": "true", "disease2": "true", "disease3": "true", "disease4": "true", "disease5": "false", "disease6": "false"
    },
    "final_diagnosis": { "disease": "Asthma" },
    "pleural_effusion_assessment": {
      "has_effusion": "false", "need_aspiration": "false", "effusion_type": "none"
