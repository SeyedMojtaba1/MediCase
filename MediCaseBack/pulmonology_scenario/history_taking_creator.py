...
from pulmonology_scenario.document import documents
...
def history_taking_creator(target_disease):
    ...
    prompt_template = PromptTemplate(
        template="""شما یک سیستم تولید سناریوی پزشکی بسیار دقیق هستید. وظیفه شما این است که بر اساس «متون رفرنس» که در اختیار شما قرار داده شده است، یک سناریوی کامل و معتبر برای بیماری {disease} تولید کنید.
