...
export const VIDEO_MAPPING = {
  ...
  ,
  old_male: {
    intro: 'assets/videos/male/old/intro.mp4',
    physical_exam: 'assets/videos/male/old/exam.mp4',
  },
  young_female: {
    patient_profile: {
      type: 'video',
      url: 'https://medicase-isfahan.com/media/scenario-videos/Clinical_Video_Generation_From_Reference.mp4'
    },
    ...
    present_illness: {
      type: 'video',
      url: 'https://medicase-isfahan.com/media/scenario-videos/Create_a_short_202602061814_dvbjk.mp4'
    },
    past_medical_history: {
      type: 'video',
      url: 'https://elmkhah.ir/wp-content/uploads/2025/12/Patient_Cough_Animation_Generation.mp4'
    ...
    'vital_signs-PR': {
      type: 'video',
      url: 'https://medicase-isfahan.com/media/scenario-videos/Whisk_mtmwgjzmrdmzmjm40izkhtotygz3qtl1mwm40sy.mp4'
    },
    'vital_signs-SpO2': {
      type: 'video',
      url: 'https://medicase-isfahan.com/media/scenario-videos/Whisk_mtmwgjzmrdmzmjm40izkhtotygz3qtl1mwm40sy.mp4',
    ...
    'vital_signs-T': {
      type: 'video',
      url: 'https://medicase-isfahan.com/media/scenario-videos/Whisk_ityjvtzmnmmymgzj1iy2adotqgnyqtl4mgo20cm.mp4',
    },
    'vital_signs-BP': {
      type: 'video',
      url: 'https://medicase-isfahan.com/media/scenario-videos/Whisk_e2mxgtmkjtnllty10yy1mwytumykrtlhrjm50iz.mp4',
    },
    'head_and_neck': {
      type: 'video',
      url: 'https://elmkhah.ir/wp-content/uploads/2025/12/تبدیل_عکس_به_ویدیو_با_صدا.mp4'
  ...
  old_female: {
    intro: 'assets/videos/female/old/intro.mp4',
    physical_exam: 'assets/videos/female/old/exam.mp4',
